...
description: A guide to contributing to the Hack the Hill project
---

<table>
  <tr>
    <th colspan="2" style={{textAlign: "center"}}><strong>Quick Reference</strong></th>
  </tr>
  <tr>
    <td style={{textAlign: "center"}}>📚 <strong><a href="https://github.com/HacktheHill/tracker-app-2024/wiki">Documentation</a></strong></td>
    <td style={{textAlign: "center"}}>🗓️ <strong><a href="https://github.com/orgs/HacktheHill/projects/6/views/1">Project Board</a></strong></td>
  </tr>
  <tr>
    <td style={{textAlign: "center"}}>💅 <strong><a href="https://www.figma.com/design/Dzki9pxG4BkSfUcQMWDILd/Track-the-Hack-2024?t=rkrFTph33UIbpLnz-1">Figma</a></strong></td>
    <td style={{textAlign: "center"}}>🌟 <strong><a href="#">Design System</a></strong></td>
  </tr>
</table>

---

### Using [Lazygit](https://github.com/jesseduffield/lazygit) and Linux/Unix
...
<details closed>
<summary>Do I need to switch to the dark side and code in shell?💀</summary>

- No you don't😂 You can simply run WSL in your VS Code terminal, or any other IDE terminal. Rather than cloning the repo on your windows machine, you'd be cloning it in a directory of your choice in the Linux OS.
- You can still access the windows filesystem from WSL and vice versa, browsing through the Linux directories with the Windows file explorer graphically. It's an deadly combo. Well done Microsoft👏

<br/>
</details>

As you go through this document, if there is a technology or process you'd like to dig deeper into, feel free to explore our [knowledge base](https://github.com/HacktheHill/tracker-app-2024/wiki/%F0%9F%93%9A-Hack-the-Hill-Development-Team-Knowledge-Base). If you find some great resources and/or have some of your own, we'd very much appreciate your contributions :)

---

### Step 1: Read our [Dev Docs](https://github.com/HacktheHill/tracker-app-2024/wiki/%F0%9F%93%93-Hack-the-Hill-Dev-Docs) to get an understanding of the technologies we use and why.
...
<details closed>
<summary> But these squigglies are so annoying😭 Can I just do `eslint ignore`? 🥺👉👈 </summary>
...
<details closed>
<summary>The error message isn't helpful, should I google the error or is there a quicker way?</summary>
...
Simply do `pnpm lint:inspect` in your terminal, and you'll see a little web app pop up in your browser. It will look like this. Click around and explore :)


<img src="https://github.com/HacktheHill/tracker-app-2024/assets/54924158/5ae8a4e4-4c80-4df8-8c3b-12607944503f" width="500" alt="image description" />
